...
// Logo variants with gradient text
const logosWithGradientText = {
  ...
  <!-- Company name "Drag AI" with gradient -->
  <text x="250" y="125" font-family="system-ui, -apple-system, sans-serif" font-size="72" font-weight="700" fill="url(#textGradient)">
    Drag AI
  </text>
</svg>`,
  ...
  <!-- Company name "Drag AI" centered below icon with gradient -->
  <text x="200" y="350" font-family="system-ui, -apple-system, sans-serif" font-size="64" font-weight="700" fill="url(#textGradient)" text-anchor="middle">
    Drag AI
  </text>
</svg>`,
  ...
  <!-- Company name "Drag AI" with extra large font for banners and gradient -->
  <text x="300" y="180" font-family="system-ui, -apple-system, sans-serif" font-size="96" font-weight="700" fill="url(#textGradient)">
    Drag AI
  </text>
</svg>`
};
...
// Write all logo files with gradient text
Object.entries(logosWithGradientText).forEach(([filename, content]) => {
  const filepath = path.join(logosDir, filename);
  fs.writeFileSync(filepath, content);
  console.log(`✅ Updated: ${filename} - Text now has purple-pink gradient`);
});

console.log('\n🎨 All logo text updated with gradient!');
console.log('\nGradient colors:');
console.log('  - Purple: #8B5CF6');
console.log('  - Pink: #EC4899');
console.log('  - Direction: Left to right (horizontal)');
